...
<div class="wrapper row3"><br>
  ...
  <main class="container clear"> 
    ...
    <form action="inventorysearch.php" name="sid" method="POST">
        <input class="form-control me-2" type="search" placeholder="Medicine or Manufacturer" aria-label="Search" name="searchstring" ><br>
        <button class="btn" type="submit" name="sid">Search</button>
    </form>
    <!-- main body -->
    <!-- ################################################################################################ -->
    <div class="content">
      ...
      <div class="scrollable">
        <table>
          ...
          <tbody>
            ...
            $query = mysqli_query($link, "SELECT * FROM medicine ORDER BY Manufacturer ASC, Name ASC");
            while($row = mysqli_fetch_array($query)){
              ...
              $q = $row['quantity'];
                ...
                ?>
                  ...
                  <td><?php echo $q ?></td>
                  <td>
                      <form action="itemdelete.php" name="itemdelete" method="POST">
                          <input type="hidden" name="itemdelete" value="<?php echo $name ?>" >
                          <button style="  background: #c31717;
  color: wheat;
  padding: 5px 25px;
  border: 0px;
  border-radius: 30px;" type="submit">Delete</button>
                      </form>
                  </td>
                </tr>
              <?php
